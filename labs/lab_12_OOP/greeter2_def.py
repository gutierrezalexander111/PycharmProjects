...
class Greeter: 
    ...
    objects that can greet you.Gracy becomes an instance of Greeter with ability to call Greeter methods like SetName and another instance is created called George"""
