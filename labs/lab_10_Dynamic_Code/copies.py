...
print "Hopefully, if you change one, you don't change the\
 other."
nest['b'] = [21, 22, 23]
...
print "OK.  That worked.  But what if you change an\
 element of a list,"
...
print "If you don't like that behavior, you can do a\
 'deepcopy'."
