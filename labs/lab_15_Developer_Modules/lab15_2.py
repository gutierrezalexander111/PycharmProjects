#!/usr/bin/env python
"""lab15_2.py  -- deals card hands:
lab15_2.py  -- deals 4 hands of 5 cards
lab15_2.py -p 6 -c 3  -- deals 6 hands of 3 cards
"""
import os, sys
try:
    ...
    sys.path.insert(0, "..") 
import lab_14_New_Style_Classes.lab14_3 as game_dealer
