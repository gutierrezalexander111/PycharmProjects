#!/usr/bin/env python
"""lab17_3.py This evil program crawls around on the web and 
...
try:
    ...
    sys.path.insert(0, "..") 
import lab_11_Function_Fancies.timeout_decorator as time_out
...
"""
$ lab17_3.py
st-ceolaser-info@ngc.com  [and many more] """
