#!/usr/bin/env python
"""lab14_1.py A SortedDictionary class with only "description"
...
class SortedDictionary(dict): 
    ...
    def __setattr__(self, attribute_name, value):
        if attribute_name not in \
               SortedDictionary.allowed_attributes:
            raise TypeError, \
                  "can't set attributes of class %s" \
...
def main():
    ...
    for d in ( {'Zero':0, 'False':0, 'None':0, 'True':1}, 
               {},                                
